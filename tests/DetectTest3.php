...
final class DetectTest3 extends TestCase
{
    ...
    {
        // Make OCR longer than the minimum length threshold so it isn't blocked for being too short
        $ocr = "Barangay Clearance\nIssued this... Additional details to exceed the minimum OCR length requirement.";
