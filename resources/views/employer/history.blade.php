...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="profile-name">{{ Auth::user()->first_name ?? 'Employer' }}</div>
    <div class="company-name">{{ Auth::user()->company_name ?? 'Company' }}</div>
    <a href="{{ route('employer.dashboard') }}" class="sidebar-btn"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
    <a href="{{ route('employer.jobs') }}" class="sidebar-btn"><i class="fas fa-briefcase"></i> My Job Posts</a>
  <a href="{{ route('employer.applicants') }}" class="sidebar-btn"><i class="fas fa-users"></i> Applicants</a>
  <a href="{{ route('employer.history') }}" class="sidebar-btn active"><i class="fas fa-history"></i> History</a>
  <a href="{{ route('employer.employees') }}" class="sidebar-btn"><i class="fas fa-user-check"></i> Employees</a>
    <a href="{{ route('settings') }}" class="sidebar-btn"><i class="fas fa-cog"></i> Settings</a>
  </div>
