{{-- 
  DEPRECATED: This layout has been replaced by jobseeker.layouts.base
  Redirecting to the new unified jobseeker layout system
--}}
@php
  // Redirect all includes to use the new jobseeker layout
